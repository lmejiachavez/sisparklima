class ParkingsController < ApplicationController
  ...
  # GET /parkings.json
  def index
    #@Parking=Parking.where("description LIKE ?", "%#{params[:search]}%")
  ...
  private
    ...
    def parking_params
      params.require(:parking).permit(:state, :date_start, :date_end, :description, :type_rent, :name_favorite, :state_favorite, :cover)
    end
end
